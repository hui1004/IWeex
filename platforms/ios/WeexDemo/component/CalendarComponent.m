...
@interface CalendarComponent()<FSCalendarDataSource,FSCalendarDelegate>
...
-(UIView*)loadView
{
    ...
    calendar.appearance.headerTitleColor = self.monthColor?:[UIColor whiteColor];
    calendar.calendarWeekdayView.backgroundColor = self.weekBgColor?:[UIColor blueColor];
    calendar.appearance.weekdayTextColor = self.weekColor?:[UIColor whiteColor];
    calendar.appearance.titleDefaultColor = self.weekdayColor?:[UIColor blackColor];
    calendar.appearance.titleWeekendColor = self.weekendColor?:[UIColor blueColor];
    calendar.appearance.titlePlaceholderColor = self.placeholderColor ?: [UIColor blackColor];
...
- (void)configureCell:(__kindof FSCalendarCell *)cell forDate:(NSDate *)date atMonthPosition:(FSCalendarMonthPosition)position
{
    ...
    rangeCell.selectionLayer.backgroundColor = self.selectColor ? self.selectColor.CGColor : [UIColor blueColor].CGColor;
    rangeCell.middleLayer.backgroundColor = self.selectColor ? [self.selectColor colorWithAlphaComponent:0.3].CGColor : [[UIColor blueColor] colorWithAlphaComponent:0.3].CGColor;
