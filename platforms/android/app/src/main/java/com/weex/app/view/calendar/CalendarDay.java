...
public final class CalendarDay implements Parcelable {
    ...
    private boolean isExacyltSameDay;

    public boolean isExacyltSameDay() {
        return isExacyltSameDay;
    }

    public void setExacyltSameDay(boolean exacyltSameDay) {
        isExacyltSameDay = exacyltSameDay;
    }
     ...
     * Get a new instance set to the specified day
     *
     * @param calendar {@linkplain Calendar} to pull date information from. Passing null will return
     *                 null
     * @return CalendarDay set to the specified date
     */
