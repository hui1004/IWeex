    ...
    public void createChildViewAt(int index) {
        ...
        if (ret.first != null) {
            ...
            if(child instanceof IWXMapMarker){
              MarkerOptions options=((IWXMapMarker) child).getOptions();
...
//              marker.setAnimation(markerAnimarion);
            }else if (child instanceof IWXInfoWindow){
                infoList.put(child.getRealView().getTag().toString(),child.getRealView());
        ...
        mapView.aMap.setInfoWindowAdapter(new AMap.InfoWindowAdapter() {
            ...
            public View getInfoWindow(Marker marker) {
                ...
                if (infoList.containsKey(showType)){
                      return (View) infoList.get(showType);
                }else{
                    return null;
                }
            }
