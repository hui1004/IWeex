...
import com.weex.app.view.WeexMapView;
...
public class IWXMap extends WXComponent<WeexMapView> {
    WeexMapView mapView;
...
//        Toast.makeText(wxInstance.getContext(),lat+""+lnt+"",Toast.LENGTH_LONG).show();
