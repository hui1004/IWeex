package baidu.speech.baidu_voice.util;
    ...
    public static Map<String, Object> getAuthParams(final Context context) {
        if (authInfo == null) {
            try {
                ...
                int appId = appInfo.metaData.getInt("com.baidu.baidu.speech.APP_ID");
                String configKey = appInfo.metaData.getString("com.baidu.baidu.speech.API_KEY");
                String configSecret = appInfo.metaData.getString("com.baidu.baidu.speech.SECRET_KEY");
