package baidu.speech.baidu_voice;
...
public class MessageStatusRecogListener extends StatusRecogListener {
    ...
    public void onAsrReady() {
        ...
        if (voiceResultLisener!=null){
            voiceResultLisener.onVoiceStart();
        }
    }
    ...
    public void onAsrPartialResult(String[] results, RecogResult recogResult) {
        ...
        if (voiceResultLisener!=null){
            voiceResultLisener.onVoiceRunning(results[0]);
        }
    }
    ...
    public void onAsrFinalResult(String[] results, RecogResult recogResult) {
        ...
        speechEndTime = 0;
        if (voiceResultLisener!=null){
            voiceResultLisener.onVoiceResult(results[0]);
        }
//        sendMessage(message, status, true);
    ...
    public void onAsrFinishError(int errorCode, int subErrorCode, String errorMessage, String descMessage,
        ...
        speechEndTime = 0;
        if (voiceResultLisener!=null){
            voiceResultLisener.onVoiceError(message);
        }
    }
    ...
    public void setOnVoiceResultLisener(OnVoiceResultLisener voiceResultLisener){
        this.voiceResultLisener=voiceResultLisener;
    }
    private OnVoiceResultLisener voiceResultLisener;
    public interface OnVoiceResultLisener{
        void onVoiceResult(String result);
        void onVoiceError(String result);
        void onVoiceEnd();
        void onVoiceStart();
        void onVoiceRunning(String reN);
    }
}
